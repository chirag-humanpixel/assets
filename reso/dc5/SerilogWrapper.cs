...
namespace ResoWebApi.Common
{
    ...
    public class SerilogWrapper : ILogger
    {
        ...
        private readonly string _logsFilePath = @"C:\inetpub\logs\RESO\LogsMyAppLog_.log";
        //private readonly string _logsFilePath = @"D:\Chirag\log\LogsMyAppLog_.log";
        ...
        private ColumnOptions GetColumnOptions()
        {
            ...
            columnOpts.AdditionalColumns = new Collection<SqlColumn>
            {
                 ...
                 new SqlColumn {ColumnName = "dd_trace_id", PropertyName= "dd_trace_id", DataType = SqlDbType.VarChar, AllowNull = true},
            };
            return columnOpts;
        }
        #endregion
